...
# Usage:
#   ./scripts/folia/vendor-folia.sh              # clone or reset to UPSTREAM.lock
#   ./scripts/folia/vendor-folia.sh --update-lock # fetch branch tip and rewrite lock
set -euo pipefail
...
# Do not edit by hand; refresh with: ./scripts/folia/vendor-folia.sh --update-lock
REPO=${REPO}
BRANCH=${BRANCH}
COMMIT=${TIP}
...
echo "Next: ./scripts/folia/build-yap-folia.sh"
