...
DOC_LIST=(
  ...
  "WHERE_WE_STAND|docs/overview/WHERE_WE_STAND.md"
  "PROJECT_STATUS|docs/overview/PROJECT_STATUS.md"
  "RELEASE_READINESS|docs/overview/RELEASE_READINESS.md"
  "COMPLETION_BACKLOG|docs/overview/COMPLETION_BACKLOG.md"
  ...
  "BENCH_BOTS|docs/performance/BENCH_BOTS.md"
