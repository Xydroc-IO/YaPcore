...
world-settings:
  default:
    ...
    entity-activation-range:
      ...
      villagers: 48
      flying-monsters: 48
      # Match config/templates/highpop — every:1/max:2000 defeated EAR and burned MSPT.
      wake-up-inactive:
...
# Product tune (docs/TUNE.md): VD=8 / sim=6. Was 10/10 — N players × sim disk dominated MSPT.
view-distance=8
simulation-distance=6
# Align with heavypop/ecosystem MSPT benches — wild spawn + bots was AI/tracker noise.
