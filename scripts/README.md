...
| `smoke-contiguous-bar.sh` | Live contiguous carve + gap hold (port 25575; lab jar) |
...
| `build-yap-client-render.sh` | Fabric `client_mods.zip` (visuals + bag + presence + blocks + staff + ultrawide) |
