...
#
# Usage:
#   ./scripts/setup/nginx-setup.sh              # install HTTP pack edge only (safe with YaP Link)
#   ./scripts/setup/nginx-setup.sh --with-stream  # ALSO install TCP/UDP :25565 → chassis (conflicts with Link)
#   ./scripts/setup/nginx-setup.sh --dry-run    # print rendered configs only
#   ./scripts/setup/nginx-setup.sh --uninstall  # remove YaPcore nginx snippets
#
