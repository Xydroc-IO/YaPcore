...
public class VelocityServer implements ProxyServer, ForwardingAudience {
  ...
  public ProxyVersion getVersion() {
    ...
    String implVendor;
    if (pkg != null) {
      implName = MoreObjects.firstNonNull(pkg.getImplementationTitle(), "YaP Link");
      implVersion = MoreObjects.firstNonNull(pkg.getImplementationVersion(), "<unknown>");
      implVendor = MoreObjects.firstNonNull(pkg.getImplementationVendor(), "YapLabs");
    } else {
      implName = "YaP Link";
      implVersion = "<unknown>";
      implVendor = "YapLabs";
  ...
  private VelocityPluginContainer createVirtualPlugin() {
    ...
    PluginDescription description = new VelocityPluginDescription(
        "yap-link", version.getName(), version.getVersion(), "YaP Link — YapLabs Velocity-class proxy",
            version.getName().equals("YaP Link") ? "https://github.com/yaplabs" : null,
