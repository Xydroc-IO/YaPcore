...
| YaP tree | [`yap-iris/`](../../yap-iris/) |
| Build | `./scripts/build-yap-client-render.sh` |

## Corresponding source

The YaPcore repository directory `yap-iris/` **is** the corresponding source for
...
[`yap-iris/LICENSE-DEPENDENCIES`](../../yap-iris/LICENSE-DEPENDENCIES) and
