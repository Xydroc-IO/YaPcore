...
public final class PermCatalog {
    ...
    private static List<Category> build() {
        ...
        out.add(cat("kits", "Kits & extras", "Kits and QoL",
                n("yapdata.kit.wood", "Wood kit", "Leather + wood tools"),
                n("yapdata.kit.diamond", "Diamond kit", "Diamond gear"),
                n("yapdata.kit.enchanted_netherite", "Enchanted netherite", "Full enchanted set"),
                n("yapdata.kit.adventurer", "Adventurer kit", "Claim adventurer"),
                n("yapdata.kit.vip", "VIP kit", "Claim VIP rank kit"),
                n("yapdata.kit.mvp", "MVP kit", "Claim MVP rank kit"),
                n("yapdata.kit.elite", "Elite kit", "Claim Elite rank kit"),
                ...
                n("yapessentials.keepinventory.xp", "Keep XP", "Keep XP on death"),
        ...
        out.add(cat("staff-move", "Staff tools", "TP / heal / fly",
                ...
                n("yapessentials.speed", "/speed", "Walk / fly speed (self)"),
                n("yapessentials.speed.others", "/speed <player>", "Set speed on others"),
        ...
        out.add(cat("admin-mod", "Admin", "Bans & ranks — grant carefully",
                ...
                n("yapessentials.god", "/god", "Invulnerability (self)"),
                n("yapessentials.god.others", "/god <player>", "Toggle god on others"),
        ...
        out.add(cat("extras", "Extras", "Stacker, QoL, packs, factions",
                ...
                n("yapqol.give", "QoL give", "Give timber axe / excavator"),
                n("yapqol.gui", "QoL GUI", "Open /yapqol gui"),
                n("yapqol.admin", "QoL admin", "Reload / toggle YaP-QoL"),
                n("yapqol.timber", "Timber axe use", "Use VIP timber axe"),
                n("yapqol.excavator", "Excavator use", "Use VIP area excavator"),
