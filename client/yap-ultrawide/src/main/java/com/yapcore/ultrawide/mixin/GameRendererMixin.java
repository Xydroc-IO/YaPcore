...
/**
 * Hor+ changes vertical FOV. Vanilla view-bob is a fixed camera translation,
 * so the world slides under a stable HUD crosshair. Scale bob with the FOV
 * ratio so placement matches where you are aiming.
 */
