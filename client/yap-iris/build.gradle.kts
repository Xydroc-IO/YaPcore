...
val SODIUM_DEPENDENCY_FABRIC by extra { "net.caffeinemc:sodium-fabric:0.9.1+mc26.2" }
val SODIUM_DEPENDENCY_NEO by extra { "net.caffeinemc:sodium-neoforge-mod:0.9.1+mc26.2" }
...
// https://semver.org/
val MOD_VERSION by extra { "1.11.2-yap" }
