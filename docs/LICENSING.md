...
the MIT terms. Include the copyright notice in copies or substantial portions.
...
| **PlaceholderAPI compat layer** | MIT (YaP reimplementation) | `yap-placeholderapi.jar` |

### Folia / Paper (GPLv3)

YaPcore does **not** fork or ship Folia/Paper source. Operators download official
builds. When you distribute a server package that includes Folia/Paper binaries,
GPLv3 obligations apply to that combined work — consult the
[Folia](https://github.com/PaperMC/Folia) / [Paper](https://github.com/PaperMC/Paper)
licenses and your legal counsel.

YaPcore's **first-party** code (chassis, plugins, Link) remains MIT unless
