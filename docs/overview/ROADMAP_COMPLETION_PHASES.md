...
- Document in `docs/data/PLAYERDATA.md` or new `docs/gameplay/REGIONS.md`
...
- Update [PHASE4_PROTOCOL.md](../protocol/PHASE4_PROTOCOL.md) rows from Partial → Done
...
- `docs/plugins/PLUGIN_COMPAT_MATRIX.md` with ≥50 common plugins classified
...
- All dashboard tabs documented in [WEB_DASHBOARD.md](../ops/WEB_DASHBOARD.md)
