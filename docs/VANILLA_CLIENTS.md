...
bands apply when `game-authority=native`. See [FOLIA_FORK.md](FOLIA_FORK.md),
[CLIENTS_AND_PACKS.md](CLIENTS_AND_PACKS.md), and [PHASE4_PROTOCOL.md](PHASE4_PROTOCOL.md).
