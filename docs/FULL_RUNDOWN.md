...
“Next-gen server software: YaP-Folia game + shipped YaP natives (not Paper + ten plugins) + YaP Link + dual-stack. See [PLUGIN_COMPAT_MATRIX.md](PLUGIN_COMPAT_MATRIX.md) · [FOLIA_FORK.md](FOLIA_FORK.md).”
...
9. **Vehicles** — real cars/trucks/exotics, fuel, upgrades, shop — [VEHICLES.md](VEHICLES.md).
...
Chassis: [YAPENGINE_16THREAD.md](YAPENGINE_16THREAD.md) · Fork: [FOLIA_FORK.md](FOLIA_FORK.md)
...
| [FOLIA_FORK.md](FOLIA_FORK.md) | YaP-Folia patches & build |
| [YAP_LINK.md](YAP_LINK.md) | YaP Link proxy |
| [YAPENGINE_16THREAD.md](YAPENGINE_16THREAD.md) | Chassis channels |
| [WEB_DASHBOARD.md](WEB_DASHBOARD.md) | Browser control |
| [VEHICLES.md](VEHICLES.md) | Vehicles |
| [PLAYERDATA.md](PLAYERDATA.md) / [YAPDB.md](YAPDB.md) / [MARIADB.md](MARIADB.md) | Data plane |
