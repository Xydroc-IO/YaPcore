...
| `fire-spread` | deny | Reserved for spread hooks |
| `mob-spawning` | allow | Reserved for spawn hooks |
...
- [PLAYERDATA.md](PLAYERDATA.md) — claims, trust, tax
- [PERMISSIONS.md](PERMISSIONS.md) — `yapdata.claims.*`, `yapregions.admin`
