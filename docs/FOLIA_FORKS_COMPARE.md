...
Methods: [BENCH_VS_FOLIA.md](BENCH_VS_FOLIA.md). Raw JSON: `bench/results/`.
...
Paper / Purpur / Leaf are **single-tick** Paper-line — see [COMPARE_ECOSYSTEM.md](COMPARE_ECOSYSTEM.md). They are not Folia peers.
...
- [BENCH_VS_FOLIA.md](BENCH_VS_FOLIA.md) — fairness contract & full tables  
- [COMPARE_ECOSYSTEM.md](COMPARE_ECOSYSTEM.md) — Paper forks + Velocity too  
- [COMPARISON_BRIEF.md](COMPARISON_BRIEF.md) — partner brief  
