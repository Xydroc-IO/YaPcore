...
| Vehicles | `/yapvehicle …` | [VEHICLES.md](VEHICLES.md) |
...
| Player data | `/yapdata …` (feature-dependent) | [PLAYERDATA.md](PLAYERDATA.md) |
| Resource packs | `/yappacks …` | [CLIENTS_AND_PACKS.md](CLIENTS_AND_PACKS.md) |
...
See [QUICK_START.md](QUICK_START.md) · [WEB_DASHBOARD.md](WEB_DASHBOARD.md).
