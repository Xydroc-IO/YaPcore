...
**YapLabs · August 2026**  
Authoritative crossplay parity checklist (replaces legacy Phase 4 protocol doc).
...
| Doc | Topic |
|-----|--------|
| [VIA_BACKWARDS_LIMITATIONS.md](VIA_BACKWARDS_LIMITATIONS.md) | Known JE limits |
...
| [CLIENTS_AND_PACKS.md](../network/CLIENTS_AND_PACKS.md) | Client matrix + packs |
| [VELOCITY.md](../network/VELOCITY.md) | yap-floodgate; no Via\* on backend |
| [VANILLA_CLIENTS.md](../network/VANILLA_CLIENTS.md) | JE bands |
