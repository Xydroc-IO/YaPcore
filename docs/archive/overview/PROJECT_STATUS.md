...
**YaPcore is a shippable YaP-Folia network product** with first-party Java + Bedrock crossplay, YaP Link proxy, and a full native plugin stack. **Automated release gates and Phase 7 (600s) play soak are green.** Remaining work: **retail Xbox login**, **G.33 skull texture**, optional perf soak — not missing core code paths.
...
| [RELEASE_READINESS.md](RELEASE_READINESS.md) | **What’s left to do + production readiness + cross-region stability** |
