...
public final class MmoBedrockUi {
    ...
    public void openRecipes(Player player, SkillId skill, int page) {
        panels.openRecipes(player, skill, page);
    }

    public void openHiscores(Player player, SkillId skill, int page) {
        panels.openHiscores(player, skill, page);
    }
    ...
    MmoBedrockConfig config() { return config; }
    BedrockUiService bedrock() { return bedrock; }

    void openHubInternal(Player player) { openHub(player); }

    void openSkillPickerInternal(Player player, String target) { openSkillPicker(player, target); }
