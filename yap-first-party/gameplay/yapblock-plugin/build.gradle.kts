...
dependencies {
    ...
    testImplementation(project(":yap-block-api"))
...
tasks.shadowJar {
    archiveFileName.set("yap-block.jar")
    archiveClassifier.set("")
    relocate("com.zaxxer.hikari", "com.yapcore.yapblock.libs.hikari")
    relocate("com.mysql", "com.yapcore.yapblock.libs.mysql")
    mergeServiceFiles()
