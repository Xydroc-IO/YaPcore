...
tasks.shadowJar {
    archiveFileName.set("yap-mmo-content.jar")
    archiveClassifier.set("")
    relocate("com.zaxxer.hikari", "com.yapcore.mmocontent.libs.hikari")
    relocate("com.mysql", "com.yapcore.mmocontent.libs.mysql")
    mergeServiceFiles()
