...
dependencies {
    ...
    implementation(project(":yap-dungeons-api"))
    ...
    testImplementation(project(":yap-dungeons-api"))
...
tasks.shadowJar {
    archiveFileName.set("yap-dungeons.jar")
    archiveClassifier.set("")
    relocate("com.zaxxer.hikari", "com.yapcore.dungeons.libs.hikari")
    relocate("com.mysql", "com.yapcore.dungeons.libs.mysql")
    mergeServiceFiles()
