...
dependencies {
    ...
    implementation(project(":yap-guilds-api"))
    ...
    testImplementation(project(":yap-guilds-api"))
...
tasks.shadowJar {
    archiveFileName.set("yap-guilds.jar")
    archiveClassifier.set("")
    relocate("com.zaxxer.hikari", "com.yapcore.guilds.libs.hikari")
    relocate("com.mysql", "com.yapcore.guilds.libs.mysql")
    mergeServiceFiles()
