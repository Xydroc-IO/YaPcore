...
class SkillPowerMathTest {
    ...
    void negativeSettingsClampToZeroBonus() {
        SkillPowerSettings settings = new SkillPowerSettings(true, -5, -2, -1, -3, -4, -2, -8, -1, SkillAbilitySettings.defaults());
    ...
    void textMatchesTheLiveSkillsOnly() {
        ...
        assertTrue(SkillPowerText.lines("mining", 50, 120, new SkillPowerSettings(false, 2.0, 2.0, 2.0, 1.0, 1.0, 0.25, 10.0, 1.0, SkillAbilitySettings.defaults())).isEmpty());
