...
public final class ClaimService {
    ...
    private final ClaimShovelOps shovel;
    ...
    public ClaimService(JavaPlugin plugin, ClaimsConfig config, ClaimRepository repo,
        ...
        this.shovel = new ClaimShovelOps(this, creation);
    }
    ...
    public String handleShovel(Player player, Location loc) throws SQLException {
        return shovel.handleShovel(player, loc);
    }
    ...
    public String claimChunkAt(Player player, Location loc) throws SQLException {
        return shovel.claimChunkAt(player, loc);
    }
    ...
    public String expandAdjacent(Player player, ClaimExpandRules.Dir dir) throws SQLException {
        return shovel.expandAdjacent(player, dir);
    }

    Corner pendingCorner(UUID uuid) {
        return pending.get(uuid);
    }

    void setPendingCorner(UUID uuid, Corner corner) {
        pending.put(uuid, corner);
    }

    void clearPendingCorner(UUID uuid) {
        pending.remove(uuid);
    }
