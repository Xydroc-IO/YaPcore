...
tasks.shadowJar {
    archiveFileName.set("yap-moderation.jar")
    archiveClassifier.set("")
    relocate("com.zaxxer.hikari", "com.yapcore.moderation.libs.hikari")
    relocate("com.mysql", "com.yapcore.moderation.libs.mysql")
    mergeServiceFiles()
