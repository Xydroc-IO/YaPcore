...
dependencies {
    ...
    testImplementation(project(":yap-conquest-api"))
...
tasks.shadowJar {
    archiveFileName.set("yap-conquest.jar")
    archiveClassifier.set("")
    relocate("com.zaxxer.hikari", "com.yapcore.conquest.libs.hikari")
    relocate("com.mysql", "com.yapcore.conquest.libs.mysql")
    mergeServiceFiles()
