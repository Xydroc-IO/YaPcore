...
dependencies {
    ...
    implementation(project(":yap-protect-api"))
    compileOnly(project(":yap-db-api"))

    implementation("com.zaxxer:HikariCP:6.2.1")
    implementation("com.mysql:mysql-connector-j:9.1.0")

    testImplementation(project(":yap-db-api"))
...
tasks.shadowJar {
    archiveFileName.set("yap-protect.jar")
    archiveClassifier.set("")
    relocate("com.zaxxer.hikari", "com.yapcore.protect.libs.hikari")
    relocate("com.mysql", "com.yapcore.protect.libs.mysql")
    mergeServiceFiles()
