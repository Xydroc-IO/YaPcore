...
dependencies {
    ...
    compileOnly(project(":yap-holo-api"))
...
tasks.shadowJar {
    archiveFileName.set("yap-npcs.jar")
    archiveClassifier.set("")
    relocate("com.zaxxer.hikari", "com.yapcore.npcs.libs.hikari")
    relocate("com.mysql", "com.yapcore.npcs.libs.mysql")
    mergeServiceFiles()
