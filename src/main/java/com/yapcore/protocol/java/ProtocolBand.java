...
public enum ProtocolBand {
    ...
    /** 1.20.5–1.21.5 */
    V1_21(766, 770, true, false, false, 0x2B, 0x41, 0x26, 0x18, 0x19, 0x22, 0x54),

    /** 1.21.6–1.21.10 — modern player_position layout */
    V1_21_6(771, 773, true, false, true, 0x2B, 0x41, 0x26, 0x1A, 0x19, 0x22, 0x54),

    /** 1.21.11 */
    V1_21_11(774, 774, true, false, true, 0x2F, 0x46, 0x2A, 0x1B, 0x18, 0x26, 0x56),

    /** 26.1.x */
    V26_1(775, 775, true, false, true, 0x31, 0x48, 0x2C, 0x1C, 0x18, 0x26, 0x5E),

    /** 26.2+ — login_finished Session ID; IDs from 26.2 packets.json */
    V26_2(776, Integer.MAX_VALUE, true, true, true, 0x31, 0x48, 0x2C, 0x1C, 0x18, 0x26, 0x5E);
    ...
    public static ProtocolBand of(int protocolVersion) {
        ...
        if (protocolVersion > V26_2.minProtocol) {
            return V26_2;
        }
        return best;
    }
    ...
    /** Player Abilities (clientbound). 26.2 = 64. */
    public int playerAbilitiesId() {
        ...
        if (minProtocol >= 774) {
            return 0x3E; // approx — unused until encoder expands
        }
        return 64;
    }
