...
public final class VanillaRegistryCatalog {
    ...
    public static final String[] DIMENSION_TYPES = {
            "minecraft:overworld", "minecraft:overworld_caves", "minecraft:the_end",
    ...
    public static final String[] BIOMES = {
            ...
            "minecraft:pale_garden", "minecraft:plains", "minecraft:river",
            "minecraft:savanna", "minecraft:savanna_plateau", "minecraft:small_end_islands",
            "minecraft:snowy_beach", "minecraft:snowy_plains", "minecraft:snowy_slopes",
            "minecraft:snowy_taiga", "minecraft:soul_sand_valley", "minecraft:sparse_jungle",
            "minecraft:stony_peaks", "minecraft:stony_shore", "minecraft:sulfur_caves",
    ...
    public static final String[] DAMAGE_TYPES = {
            ...
            "minecraft:outside_border", "minecraft:player_attack", "minecraft:player_explosion",
            "minecraft:sonic_boom", "minecraft:spear", "minecraft:spit",
            "minecraft:stalagmite", "minecraft:starve", "minecraft:sting",
            "minecraft:sulfur_cube_hot", "minecraft:sweet_berry_bush", "minecraft:thorns",
            "minecraft:thrown", "minecraft:trident", "minecraft:unattributed_fireball",
            "minecraft:wind_charge", "minecraft:wither", "minecraft:wither_skull",
    };

    public static final String[] CHAT_TYPES = {
    ...
    public static final String[] WORLD_CLOCKS = {
            "minecraft:overworld", "minecraft:the_end",
    };

    public static final String[] TIMELINES = {
            "minecraft:day", "minecraft:early_game", "minecraft:moon",
            "minecraft:villager_schedule",
    };

    public static final String[] PAINTING_VARIANTS = {
    ...
    public static final String[] CAT_VARIANTS = {
    ...
    public static final String[] CAT_SOUND_VARIANTS = {
            "minecraft:classic", "minecraft:royal",
    };

    public static final String[] CHICKEN_VARIANTS = {
            "minecraft:cold", "minecraft:temperate", "minecraft:warm",
    };

    public static final String[] CHICKEN_SOUND_VARIANTS = {
    ...
    public static final String[] COW_SOUND_VARIANTS = {
            "minecraft:classic", "minecraft:moody",
    };

    public static final String[] FROG_VARIANTS = {
            "minecraft:cold", "minecraft:temperate", "minecraft:warm",
    };

    public static final String[] PIG_VARIANTS = {
            "minecraft:cold", "minecraft:temperate", "minecraft:warm",
    };

    public static final String[] PIG_SOUND_VARIANTS = {
            "minecraft:big", "minecraft:classic", "minecraft:mini",
    };

    public static final String[] WOLF_VARIANTS = {
            "minecraft:ashen", "minecraft:black", "minecraft:chestnut",
            "minecraft:pale", "minecraft:rusty", "minecraft:snowy",
            "minecraft:spotted", "minecraft:striped", "minecraft:woods",
    };

    public static final String[] WOLF_SOUND_VARIANTS = {
            "minecraft:angry", "minecraft:big", "minecraft:classic",
            "minecraft:cute", "minecraft:grumpy", "minecraft:puglin",
            "minecraft:sad",
    };

    public static final String[] ZOMBIE_NAUTILUS_VARIANTS = {
            "minecraft:temperate", "minecraft:warm",
    };

    public static final String[] SULFUR_CUBE_ARCHETYPES = {
            "minecraft:bouncy", "minecraft:explosive", "minecraft:fast_flat",
            "minecraft:fast_sliding", "minecraft:high_resistance", "minecraft:hot",
            "minecraft:light", "minecraft:regular", "minecraft:slow_bouncy",
            "minecraft:slow_flat", "minecraft:slow_sliding", "minecraft:sticky",
    };
    ...
    public static final String[] JUKEBOX_SONGS = {
            "minecraft:11", "minecraft:13", "minecraft:5",
            "minecraft:blocks", "minecraft:bounce", "minecraft:cat",
            "minecraft:chirp", "minecraft:creator", "minecraft:creator_music_box",
            "minecraft:far", "minecraft:lava_chicken", "minecraft:mall",
            "minecraft:mellohi", "minecraft:otherside", "minecraft:pigstep",
            "minecraft:precipice", "minecraft:relic", "minecraft:stal",
            "minecraft:strad", "minecraft:tears", "minecraft:wait",
            "minecraft:ward",
    };

    public static final String[] TRIM_MATERIALS = {
    ...
    public static final String[] TRIM_PATTERNS = {
            "minecraft:bolt", "minecraft:coast", "minecraft:dune",
            "minecraft:eye", "minecraft:flow", "minecraft:host",
            "minecraft:raiser", "minecraft:rib", "minecraft:sentry",
            "minecraft:shaper", "minecraft:silence", "minecraft:snout",
            "minecraft:spire", "minecraft:tide", "minecraft:vex",
            "minecraft:ward", "minecraft:wayfinder", "minecraft:wild",
    };

    public static final String[] BANNER_PATTERNS = {
            "minecraft:base", "minecraft:border", "minecraft:bricks",
            "minecraft:circle", "minecraft:creeper", "minecraft:cross",
            "minecraft:curly_border", "minecraft:diagonal_left", "minecraft:diagonal_right",
            ...
            "minecraft:half_horizontal_bottom", "minecraft:half_vertical", "minecraft:half_vertical_right",
            "minecraft:mojang", "minecraft:piglin", "minecraft:rhombus",
            ...
            "minecraft:stripe_middle", "minecraft:stripe_right", "minecraft:stripe_top",
            "minecraft:triangle_bottom", "minecraft:triangle_top", "minecraft:triangles_bottom",
    ...
    public static final String[] ENCHANTMENTS = {
            ...
            "minecraft:lunge", "minecraft:lure", "minecraft:mending",
