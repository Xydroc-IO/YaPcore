...
public final class PluginConfigHints {
    ...
    private static final Map<String, String> TITLES = Map.ofEntries(
            ...
            Map.entry("timber.enabled", "Enable timber axe whole-tree chop"),
            Map.entry("timber.max-logs", "Max logs felled per chop"),
            Map.entry("timber.break-leaves", "Also break canopy leaves"),
            Map.entry("timber.max-leaves", "Max leaves broken per chop"),
            Map.entry("excavator.enabled", "Enable area excavator pickaxe"),
            Map.entry("excavator.sizes", "Allowed mine sizes (e.g. 3,6,9)"),
            Map.entry("excavator.default-size", "Default excavator size"),
            Map.entry("excavator.max-blocks-per-swing", "Safety cap on blocks per swing"),
            Map.entry("excavator.require-correct-tool", "Only break blocks this pick can harvest"),
            ...
            Map.entry("settings.enabled", "Turn encyclopedia knobs on"),
            Map.entry("claims.tax.enabled", "Charge claim upkeep tax"),
            Map.entry("claims.require-claim-to-build", "Require a claim to build"),
            Map.entry("require-claim-to-build", "Require a claim to build"),
            Map.entry("markers.claims", "Show claims on the map"),
            Map.entry("relay.mc-to-discord", "Send Minecraft chat to Discord"),
            Map.entry("relay.discord-to-mc", "Send Discord chat to Minecraft"),
            ...
            Map.entry("persist", "Save holograms to disk"),
            Map.entry("line-spacing", "Space between hologram lines"),
            Map.entry("view-distance", "How far holograms are visible"),
            Map.entry("refresh-ticks", "How often visibility is refreshed"),
            Map.entry("entity", "Packet entity type"),
            Map.entry("placeholders", "Resolve %player_name% / PlaceholderAPI on hologram lines"),
            Map.entry("click-cooldown-ticks", "Ticks between hologram click actions"),
            Map.entry("hologram-nametags", "Use YaPHolo nametags on NPCs"),
            Map.entry("nametag-offset", "Extra height above the NPC for the hologram name"),
            Map.entry("intercept", "Intercept packets"),
            Map.entry("debug-listeners", "Log packet listeners"),
    ...
    private static final Map<String, String> HINTS = Map.ofEntries(
            ...
            Map.entry("claims.tax.enabled", "Off by default (typical SMP). Enable when you want claim upkeep."),
            Map.entry("claims.require-claim-to-build", "Off = wilderness building allowed. On = players must claim first."),
            Map.entry("require-claim-to-build", "Off = wilderness building allowed. On = players must claim first."),
            Map.entry("markers.claims", "Shows player land claims on the web map (HTTP still localhost by default)."),
            Map.entry("relay.mc-to-discord", "Needs a chat webhook or bot channel. Keep off until Discord is wired."),
            Map.entry("relay.discord-to-mc", "Needs inbound HTTP or bot. Keep off until Discord is wired."),
            ...
            Map.entry("jdbc.password", "Same password as your DB .env (MariaDB, Postgres, or SQLite file). Keep private."),
    ...
    private static final Map<String, String> GROUPS = Map.ofEntries(
            ...
            Map.entry("kits", "Kits"),
            Map.entry("timber", "Timber axe"),
            Map.entry("excavator", "Area excavator"),
    ...
    private static final Map<String, String> TITLES_PLUGIN = Map.ofEntries(
            ...
            Map.entry("yap-conquest", "Conquest"),
            Map.entry("yap-npcs", "NPCs"),
            Map.entry("yap-holo", "Holograms"),
            Map.entry("yap-lib", "Packet intercept"),
            Map.entry("yap-regions", "Regions"),
            Map.entry("yap-portals", "Fleet portals"),
            Map.entry("yap-lagguard", "Lag guard"),
            Map.entry("yap-mobs", "Mob mechanics"),
    ...
    private static final Map<String, String> BLURBS = Map.ofEntries(
            ...
            Map.entry("yap-chat", "Chat channels, filter, unsigned fix. Packet mute/filter when YaPLib is installed."),
            ...
            Map.entry("yap-guard", "Light anti-cheat. Packet speed/reach/scaffold when YaPLib is installed. Grim for PvP."),
            Map.entry("yap-db", "Shared SQL connection (YaPDB) used by other plugins."),
            ...
            Map.entry("yap-factions", "Opt-in: claim land with a faction. Installed, off by default."),
            Map.entry("yap-conquest", "Opt-in chunk-grid land inside YaPFactions (conquest.yml, off by default)."),
            Map.entry("yap-npcs", "Quest NPCs, dialogue, and hub actions (shop/warp/spawn/command)."),
            Map.entry("yap-holo", "Packet floating text — attach, clicks, items, pages, PAPI. Needs YaPLib."),
            Map.entry("yap-lib", "Folia-safe packet intercept. Holograms are YaPHolo."),
            Map.entry("yap-regions", "Named areas with their own rules."),
            Map.entry("yap-portals", "Product default: walk-through colored fleet portals via YaP Link (particles + light, no glass). On by default."),
            Map.entry("yap-lagguard", "Slows the world down when the server is busy."),
            Map.entry("yap-mobs", "Opt-in: mob/item/spawner stacking and distance-based mob levels."),
            ...
            Map.entry("yap-dungeons", "Opt-in: instanced dungeons. Needs SQL and packs when enabled."),
