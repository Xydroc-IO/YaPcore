...
public final class PluginConfigHints {
    ...
    private static final Map<String, String> TITLES_PLUGIN = Map.ofEntries(
            ...
            Map.entry("yap-vehicles", "Vehicles"),
            Map.entry("yap-abilities", "Abilities"),
    ...
    private static final Map<String, String> BLURBS = Map.ofEntries(
            ...
            Map.entry("yap-vehicles", "Cars, fuel, and the vehicle shop."),
            Map.entry("yap-abilities", "Spell book and combat hotbar."),
            ...
            Map.entry("yap-guilds", "Player guilds and guild chat."),
            Map.entry("yap-npcs", "Talking villagers and shop NPCs."),
