...
public final class BedrockPaperRecipes {
    ...
    public int[] craftResultFromGrid(String username, String[] materialNames, int[] counts) {
        ...
        try {
            ...
            for (int i = 0; i < 9; i++) {
                ...
                Object mat = matchMaterial(matCl, m);
                if (mat == null) {
                    matrix[i] = null;
                    continue;
                }
            ...
            while (it.hasNext()) {
                ...
                if (matchesCraftingRecipe(recipe, matrix, matCl, stackCl, cl)) {
    ...
    private static Object matchMaterial(Class<?> matCl, String name) throws Exception {
    ...
    private static boolean matchesCraftingRecipe(Object recipe, Object[] matrix,
    ...
    private static Object firstChoice(Object ingredient, Class<?> matCl, Class<?> stackCl) throws Exception {
        if (ingredient == null) {
            return null;
        }
    ...
    private static Object toStack(Object matOrStack, Class<?> matCl, Class<?> stackCl) throws Exception {
        if (matOrStack == null) {
            return null;
        }
    ...
    private static boolean matrixMatches(Object[] expected, Object[] matrix) throws Exception {
        for (int i = 0; i < 9; i++) {
    ...
    private static boolean sameType(Object a, Object b) throws Exception {
        if (a == null || b == null) {
            return a == b;
        }
