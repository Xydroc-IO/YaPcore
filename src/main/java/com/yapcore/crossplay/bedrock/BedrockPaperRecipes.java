...
public final class BedrockPaperRecipes {
    ...
    private final BedrockPaperSpecialtyRecipes specialty;

    public BedrockPaperRecipes(BedrockPaperWorldSync world) {
        this.world = world;
        this.specialty = new BedrockPaperSpecialtyRecipes(world);
    }
    ...
    public int[] applySpecialtyPick(String username, int containerType, int netId) {
        return specialty.applySpecialtyPick(username, containerType, netId);
    }

    /** Result slot index within the virtual container window. */
    public static int specialtyResultSlot(int containerType) {
        return BedrockPaperSpecialtyRecipes.specialtyResultSlot(containerType);
    }
    ...
    static int[] stackToNetwork(Object stack) throws Exception {
        if (stack == null) {
            return null;
        }
